...
def blokk_og_ws(streng):
    ny_streng=streng.lstrip()
    ny_streng=ny_streng.rstrip()
    ny_streng=ny_streng.upper()
    return ny_streng
...
def splitting(streng,karakter):
    splittet=streng.split(karakter)
    return splittet

splitting("Hakuna Matata",'a')
