...
streng_liste = ["abc","defg","hijklm","nop"]

def settsammen(liste):
    sammensatt = ""
    for streng in liste:
        sammensatt += streng
    return sammensatt

settsammen(streng_liste)
...
def forste_karakter(liste):
    bokstaver = [liste[0] for liste in liste]
    print(" \n".join(bokstaver))

forste_karakter(["UKA","lever","videre"])
