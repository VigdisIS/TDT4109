...
nedre_grense = int(input("Hvilket tall skal være den nedre grensa? "))
ovre_grense = int(input("Hvilket tall skal være den øvre grensa? "))
                 
tilfeldigTall = random.randint(nedre_grense, ovre_grense)
print(tilfeldigTall)
gjett = ""

while gjett is not tilfeldigTall:
